...
#Get futures balances. Must be USDT since this is what is used as margin.
...
def initialise_futures(client, _market="BTCUSDT", _leverage=1, _margin_type="ISOLATED"):
    try:
...
#get trades opened that the bot is trading in
